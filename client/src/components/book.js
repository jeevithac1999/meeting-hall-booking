...
const Book= (props) => {
  ...
  const [styles] = useState(["Any Style", "Bоаrdrооm Style", "Hоllоw Sԛuаrе Style", "U-Shape Style"]);
  ...
  }, [selection.time, selection.date, selection.size, selection.style]);
